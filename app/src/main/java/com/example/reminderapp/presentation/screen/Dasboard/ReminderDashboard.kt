...
import com.example.reminderapp.presentation.screen.Dasboard.AddRemainderScreen
import com.example.reminderapp.presentation.screen.Dasboard.DashBoardViewModel
import com.example.reminderapp.presentation.screen.Dasboard.DashBoardViewModelFactory
...
fun BoxRemainder(
    ...
    LazyColumn (modifier = Modifier.padding(16.dp)){
        items(firebaseReminder.value.size){reminder->
            ReminderCard(reminder = firebaseReminder.value[reminder],
                onEditClick = {
